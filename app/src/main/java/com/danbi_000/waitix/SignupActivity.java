...
//        setContentView(R.layout.layout_dbdemo);
        ...
        dbHelper = new MyDBHelper(SignupActivity.this);
        init();
    }
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btnInsert:
                    ...
                    if(resultInsert == -1){
                        Toast.makeText(SignupActivity.this, "Some error occurred while inserting", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(SignupActivity.this, "Data inserted successfully, ID: " + resultInsert, Toast.LENGTH_SHORT).show();
                    }
                    break;
                ...
                case R.id.btnUpdate:
                    long resultUpdate = dbHelper.update(Integer.parseInt(getValue(etID)), getValue(etFirstName),
                            getValue(etLastName), getValue(etAddress), Double.valueOf(getValue(etSalary)));
                    if(resultUpdate == 0){
                        Toast.makeText(SignupActivity.this, "Some error occurred while updating", Toast.LENGTH_SHORT).show();
                    } else if(resultUpdate == 1) {
                        Toast.makeText(SignupActivity.this, "Data updated successfully, ID: " + resultUpdate, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(SignupActivity.this, "Some error occurred, multiple records updated.", Toast.LENGTH_SHORT).show();
                    }
                    break;
                ...
                case R.id.btnDelete:
                    ...
                    if(resultDelete == 0){
                        ...
                        Toast.makeText(SignupActivity.this, "Data deleted successfully.", Toast.LENGTH_SHORT).show();
                    }
                    break;
